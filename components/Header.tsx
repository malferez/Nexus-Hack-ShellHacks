...
const Header: React.FC<HeaderProps> = ({ currentUser, setView, pendingNotifications, onAcceptRequest, onDeclineRequest }) => {
          ...
          <nav className="flex items-center space-x-2 sm:space-x-4">
            ...
            {currentUser.team && (
             ...
             <div className="relative" ref={requestsRef}>
                <button onClick={() => setIsRequestsOpen(prev => !prev)} className="relative text-shell-text-secondary hover:text-shell-accent transition-colors">
                    Requests
